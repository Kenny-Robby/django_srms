...
#     def __str__(self):
#         return f"{self.level} - {self.course}"
...
#     def countSubjects(self):
#         return self.studentsubjectresult_set.count()

#     def average(self):
#         resultCount = self.countSubjects()
#         if resultCount == 0:
#             return 0
#         else:
#             results = self.studentsubjectresult_set.aggregate(Sum('score'))['score__sum']
#             return results / resultCount if results else 0

# class Student_Subject_Result(models.Model):
#     result = models.ForeignKey(Result, on_delete=models.CASCADE)
#     subject = models.ForeignKey(Subject, on_delete=models.CASCADE)
#     score = models.FloatField(default=0)
#     grade = models.CharField(max_length=2, choices=[('A', 'A'), ('B+', 'B+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('F', 'F')])
...
#     subject = models.ForeignKey(Subject, on_delete=models.CASCADE)
#     score = models.FloatField(default=0)
#     grade = models.CharField(max_length=2, choices=[('A', 'A'), ('B+', 'B+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('F', 'F')], blank=True, null=True)
#     grade_point = models.FloatField(blank=True, null=True)
